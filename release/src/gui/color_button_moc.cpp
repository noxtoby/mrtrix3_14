...
QT_MOC_LITERAL(4, 31, 11), // "chooseColor"
QT_MOC_LITERAL(5, 43, 5) // "color"

    },
    "QColorButton\0changed\0\0newColor\0"
    "chooseColor\0color"
};
...
void QColorButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QColorButton::*_t)(const QColor & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QColorButton::changed)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QColorButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_QColorButton.data,
      qt_meta_data_QColorButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
