...
const QMetaObject MR::GUI::LightingSettings::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_MR__GUI__LightingSettings.data,
      qt_meta_data_MR__GUI__LightingSettings,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
