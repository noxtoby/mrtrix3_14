...
const QMetaObject MR::GUI::Dialog::ImageProperties::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MR__GUI__Dialog__ImageProperties.data,
      qt_meta_data_MR__GUI__Dialog__ImageProperties,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
