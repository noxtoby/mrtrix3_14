...
void MR::GUI::MRView::AdjustButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (AdjustButton::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AdjustButton::valueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (AdjustButton::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AdjustButton::valueChanged)) {
                *result = 1;
                return;
            }
...
const QMetaObject MR::GUI::MRView::AdjustButton::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_MR__GUI__MRView__AdjustButton.data,
      qt_meta_data_MR__GUI__MRView__AdjustButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
