...
const QMetaObject MR::GUI::MRView::ComboBoxWithErrorMsg::staticMetaObject = {
    { &QComboBox::staticMetaObject, qt_meta_stringdata_MR__GUI__MRView__ComboBoxWithErrorMsg.data,
      qt_meta_data_MR__GUI__MRView__ComboBoxWithErrorMsg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
