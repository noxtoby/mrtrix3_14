...
const QMetaObject MR::GUI::SpinBox::staticMetaObject = {
    { &QSpinBox::staticMetaObject, qt_meta_stringdata_MR__GUI__SpinBox.data,
      qt_meta_data_MR__GUI__SpinBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
