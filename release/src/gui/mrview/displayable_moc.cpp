...
struct qt_meta_stringdata_MR__GUI__MRView__Displayable_t {
    QByteArrayData data[3];
    char stringdata0[45];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MR__GUI__MRView__Displayable_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MR__GUI__MRView__Displayable_t qt_meta_stringdata_MR__GUI__MRView__Displayable = {
    {
QT_MOC_LITERAL(0, 0, 28), // "MR::GUI::MRView::Displayable"
QT_MOC_LITERAL(1, 29, 14), // "scalingChanged"
QT_MOC_LITERAL(2, 44, 0) // ""

    },
    "MR::GUI::MRView::Displayable\0"
    "scalingChanged\0"
};
...
void MR::GUI::MRView::Displayable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Displayable::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Displayable::scalingChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MR::GUI::MRView::Displayable::staticMetaObject = {
    { &QAction::staticMetaObject, qt_meta_stringdata_MR__GUI__MRView__Displayable.data,
      qt_meta_data_MR__GUI__MRView__Displayable,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MR::GUI::MRView::Displayable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MR__GUI__MRView__Displayable.stringdata0))
