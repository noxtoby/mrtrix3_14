...
const QMetaObject MR::GUI::MRView::ColourMapButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_MR__GUI__MRView__ColourMapButton.data,
      qt_meta_data_MR__GUI__MRView__ColourMapButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
