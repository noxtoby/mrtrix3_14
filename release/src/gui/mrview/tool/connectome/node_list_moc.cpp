...
const QMetaObject MR::GUI::MRView::Tool::Node_list::staticMetaObject = {
    { &Tool::Base::staticMetaObject, qt_meta_stringdata_MR__GUI__MRView__Tool__Node_list.data,
      qt_meta_data_MR__GUI__MRView__Tool__Node_list,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
