...
void MR::GUI::MRView::Tool::NodeSelectionSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (NodeSelectionSettings::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NodeSelectionSettings::dataChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MR::GUI::MRView::Tool::NodeSelectionSettings::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MR__GUI__MRView__Tool__NodeSelectionSettings.data,
      qt_meta_data_MR__GUI__MRView__Tool__NodeSelectionSettings,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
const QMetaObject MR::GUI::MRView::Tool::NodeSelectionSettingsFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_MR__GUI__MRView__Tool__NodeSelectionSettingsFrame.data,
      qt_meta_data_MR__GUI__MRView__Tool__NodeSelectionSettingsFrame,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
