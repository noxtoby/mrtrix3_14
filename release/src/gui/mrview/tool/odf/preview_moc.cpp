...
void MR::GUI::MRView::Tool::ODF_Preview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ODF_Preview *_t = static_cast<ODF_Preview *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject MR::GUI::MRView::Tool::ODF_Preview::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MR__GUI__MRView__Tool__ODF_Preview.data,
      qt_meta_data_MR__GUI__MRView__Tool__ODF_Preview,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MR::GUI::MRView::Tool::ODF_Preview::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MR__GUI__MRView__Tool__ODF_Preview.stringdata0))
        return static_cast<void*>(const_cast< ODF_Preview*>(this));
