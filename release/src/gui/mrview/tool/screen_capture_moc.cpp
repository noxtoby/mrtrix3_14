...
const QMetaObject MR::GUI::MRView::Tool::Capture::staticMetaObject = {
    { &Base::staticMetaObject, qt_meta_stringdata_MR__GUI__MRView__Tool__Capture.data,
      qt_meta_data_MR__GUI__MRView__Tool__Capture,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
