...
void MR::GUI::MRView::Tool::Tractogram::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Tractogram::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Tractogram::scalingChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MR::GUI::MRView::Tool::Tractogram::staticMetaObject = {
    { &Displayable::staticMetaObject, qt_meta_stringdata_MR__GUI__MRView__Tool__Tractogram.data,
      qt_meta_data_MR__GUI__MRView__Tool__Tractogram,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
